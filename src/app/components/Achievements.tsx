...
const Achievements = () => {
  return (
    <div className="py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
      <div className="border-black border-2 rounded-sm py-8 px-17 flex flex-row flex-wrap items-center justify-evenly">
        {achievementData.map((achievement, index) => {
          return (
            ...
            >
              <h2 className="text-stone-700 text-4xl font-bold">
                {achievement.value}
              </h2>
        ...
        {techData.map((tech, index) => {
          return (
            ...
            >
              <Image 
                src={`/images/icons/${tech === 'C#' ? 'Csharp' : tech === "Node.js" ? 'Node' : tech}.png`}
                alt={`${tech} logo`}
                height={100}
                width={100}
                className="p-2"
              />
              <h2 className="text-stone-700 text-base font-bold mb-4">{tech}</h2>
            </div>
          );
        })}
  </div>
